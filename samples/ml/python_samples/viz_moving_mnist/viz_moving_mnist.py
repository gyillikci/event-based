...
To use this sample, download MNIST.ZIP at
https://kdrive.infomaniak.com/app/share/975517/3c529307-3cec-4fc6-bbb3-87a95c6ef6cf
"""
import sys
import time
import numpy as np
...
def show_mnist(dataset_dir, tbins=10, height=128, width=128, num_workers=1, batch_size=8, max_frames_per_video=20):
    ...
    Args:
        dataset_dir (str): directory where the data is stored (unarchived MNIST.ZIP)
