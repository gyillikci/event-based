...
def _parse_args(argv=None):
    ...
    parser.add_argument('--val-dataset-path', default="", help='Path of the directory containing Labeled flow data'
                                                               ' as DAT event files and HDF5 flow files.')
    ...
    parser.add_argument('--rnn-cell', type=str, default='lstm',
                        choices=("lstm", "gru"), help='type of cell used for the convolutional RNN')
...
def main(params):
    ...
    params.preprocess_dim, params.preprocess, params.delta_t, _, _, params.preprocess_kwargs = infer_preprocessing(
        params)
