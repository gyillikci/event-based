...
public:
    ...
    /// @param cluster_config Output line cluster configuration
    /// @param particle_config Output line particle configuration
    /// @param precision_time_us Output duration of the events slices
    /// @return true in case of success
    bool load_config(LineClusterTrackingConfig &cluster_config, LineParticleTrackingConfig &particle_config,
                     unsigned int &precision_time_us);
